...
<form action="" method="post" enctype="multipart/form-data">
							...
							<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
								...
								<tfoot>
								 ...
								 <?php
										...
										$get_pro = " select * from customers where type like '%pending%'";
									...
									<td>
								<input type="checkbox" name="remove[]" value="<?php echo $row_pro['customers_id']; ?>">
								 <input type="hidden" class="form-control"   name="approv" value="Approved" />
									</td>
									</tr>
	...
	if(isset($_POST['update']))
	{
		foreach($_POST['remove'] as $remove_id )
		{
			...
			$approveadmin = "update customers set 
				type='$pro_type' where customers_id='$remove_id' AND customers_ip='$ip'";
